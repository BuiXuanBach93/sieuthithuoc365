...
class Post extends Model 
{
    ...
    public static function getProductCampaigns() {
        try {
            $postModel = new Post();
            ...
            $notify = $postModel->select(
                ...
                )->where('posts.post_type', 'product-campaign')->orderBy('post_id', 'desc')->get();

            return $notify;
        } catch (\Exception $e) {
            Log::error('http->site->ProductController->getCustomerNotifications: Lỗi lấy dữ liệu campaign');
