            ...
            <div id="content" class="detail clearfix">
               <div id="detail-product" class="clearfix">
                  <div class="thumb">
                     ...
                     <form action="{{ route('sub_contact') }}" onsubmit="return contact(this)">
                        {{ csrf_field() }}
                  ...
                  <div class="summary">
                     <div class="a_right clearfix">
                        ...
                        <p class="thuonghieu">Thương hiệu: <span>{{ isset($product->brand_name) ? $product->brand_name : 'Đang cật nhật'}}</span></p>
					 ...
					 <div class="pd20">
						 ...
						 <div class="buy-tools clearfix">
                          ...
                          <input type="hidden" name="btnType" value="6"/>
