...
@section('meta_description', 'Đăng ký tài khoản')
@section('meta_url', 'https://sieuthithuoc365.com/trang/dang-ky' )
@section('canonical', 'https://sieuthithuoc365.com/trang/dang-ky' )
@section('content')
            ...
            <div class="breadcrumbs">
                <div class="wrapper">
                    <ul>
                        ...
                        <li class="breadcrumb-item">
                            <a itemprop="url" href="" title="Liên hệ"><span itemprop="title">Đăng ký</span></a>
                        </li>
                    </ul>
                </div>
            </div><!--end: .breadcrumbs-->
