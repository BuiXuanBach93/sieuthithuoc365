                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role">
                                    ...
                                    <option value="3" @if($user->role == 3) selected @endif>Quản trị viên</option>
                                    <option value="4" @if($user->role == 5) selected @endif>Nhân viên kho</option>
                                    <option value="6" @if($user->role == 6) selected @endif>Tư vấn viên</option>
                                </select>
                            </div>
