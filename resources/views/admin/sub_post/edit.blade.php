                ...
                <div class="col-xs-12 col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Dữ liệu bổ sung</label>
                                <input type="text" class="form-control" name="additional_data" placeholder="Dữ liệu bổ sung" value="{{ $post->additional_data }}">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputEmail1">Campaign Click</label>
                                <label>{{ $post->count_click }}</label>
                            </div>
