                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="short_name" placeholder="Tên ngắn" >
                            </div>

                             <div class="form-group">
                                <label for="exampleInputEmail1">Thương hiệu</label>
                                <input type="text" class="form-control" name="brand_name" placeholder="Thương hiệu" >
                            </div>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                                ...
                                <input type="checkbox" name="just_view" class="flat-red">
                        </div>
                        <div class="box-body">
                                <label>Tag Bán chạy</label>
                                <input type="checkbox" name="popular_tag" class="flat-red">
                        </div>
                        <div class="box-body">
                                <label for="exampleInputEmail1">Link sản phẩm gốc</label>
                                <input type="text" class="form-control" name="canonical_link" placeholder="Link sp gốc" >
                         </div>
                    </div>
